...
import { blue, white, green, gray, transparent, red, bdOrange, bdPurple, darkBlue, lightBlue, orange } from '@constants/colors';
...
export default StyleSheet.create({
  ...
  // Colors
  ...getColors({ blue, gray, green, white, bdOrange, bdPurple, darkBlue, lightBlue, orange }),
  // Sizes
  ...getSizes({
